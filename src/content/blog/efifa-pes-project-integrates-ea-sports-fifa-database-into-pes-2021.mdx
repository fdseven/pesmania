...
<div className="flex flex-wrap gap-2">
  ...
  >
    ...
    <p class="group-hover:!text-skin-accent transition duration-500">EPP 23 ALL IN ONE V3</p>
</LinkButton>
  <LinkButton
    targetNew={true}
    title="Part 2"
  ...
  >
    ...
    <p class="group-hover:!text-skin-accent transition duration-500">EPP 24 UPDATE V3.3</p>
</LinkButton>
</div>
