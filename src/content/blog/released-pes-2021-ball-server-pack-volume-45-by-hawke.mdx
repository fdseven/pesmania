---
author: fdseven
pubDatetime: 2024-05-06T07:11:48.390Z
title: Released PES 2021 Ball Server Pack Volume 45 by Hawke
postSlug: released-pes-2021-ball-server-pack-volume-45-hawke
featured: false
draft: false
tags:
  - ball server
  ...
  - downloads
description: |-
  1135 Quality balls available for selection via the BallServer Sider Overlay Menu:
  Balls auto linked to over 30+ competitions via map_competitions.txt
type: Blog post
lastmod: 2024-05-06T07:13:50.466Z
isFeatured: 2024-03-20T23:55:17.514Z
coverImage: /assets/ballpack-45-hawke.png
keywords:
  - Ball Server
  - Module
  - PES 2021
...
<div class="col-span-8 md:col-start-2 md:col-span-6 lg:col-start-2 lg:col-span-4 [&>h2]:!mt-0">
  ## Here is PES 2021 1135 Quality balls available for selection via the BallServer Sider Overlay Menu. Balls auto linked to over 30+ competitions via map_competitions.txt
...
<div className="flex flex-wrap gap-2">
  <LinkButton
    targetNew={true}
    title="Ball Server Pack Vol 45"
    href="https://www.mediafire.com/file/jip60gs3gl9dlx5/BallServer+Pack+45+AIO.7z/file"
